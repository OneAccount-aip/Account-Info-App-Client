...
const SendPage = () => {
    ...
    const setBankIcon = (name) => {
        ...
        if (name === "4")
            ...
            url = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTKbpZsX4qtFKsbiyeqbgbzJtvlpIa6o3hpKA&usqp=CAU"
        else if (name === "27")
            url = "https://play-lh.googleusercontent.com/zNgjXUUn-Do-VtbAPYHD5RU3o5c-JcpRJdkP0anQLk3PYLLCm8-reGzg2o1-2X681A"
        else
